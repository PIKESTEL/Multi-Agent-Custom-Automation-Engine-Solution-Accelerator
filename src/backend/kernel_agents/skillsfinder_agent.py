...
from kernel_tools.skillsfinder_tools import SkillsfinderTools
...
class SkillsfinderAgent(BaseAgent):
    ...
    def __init__(
        ...
        agent_name: str = AgentType.SKILLSFINDER.value,
        client=None,
        definition=None,
    ) -> None:
        """Initialize the Skillsfinder Agent.
        ...
        Args:
            ...
            agent_name: Optional name for the agent (defaults to "SkillsfinderAgent")
            config_path: Optional path to the Skillsfinder tools configuration file
            client: Optional client instance
            definition: Optional definition instance
        """
        # Load configuration if tools not provided
        if not tools:
            # Get tools directly from SkillsfinderTools class
            tools_dict = SkillsfinderTools.get_all_kernel_functions()
    ...
    async def create(
        ...
        **kwargs: Dict[str, str],
        ...
        try:
            logging.info("Initializing SkillsfinderAgent from async init azure AI Agent")
            ...
            logging.error(f"Failed to create Azure AI Agent for SkillsfinderAgent: {e}")
            raise
    ...
    def default_system_message(agent_name=None) -> str:
        ...
        """
        return "You are a Skillsfinder agent. You have knowledge about the employees that are technicians, and for each of the technicians the unique skills and expertise they have. When asked to call a function, you should summarize back what was done."

    @property
    def plugins(self):
        """Get the plugins for the skillsfinder agent."""
        return SkillsfinderTools.get_all_kernel_functions()
